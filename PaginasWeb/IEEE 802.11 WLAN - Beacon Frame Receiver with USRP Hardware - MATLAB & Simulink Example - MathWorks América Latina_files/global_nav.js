  ...
  GlobalNav.subdomainToLangMappings = {
		  ...
		  GlobalNav.mwa_dropdown_labels = {
		      "en": {
		        ...
		        "associateLicense": "Associate License",
		      ...
		      "fr": {
		        ...
		        "associateLicense": "Associerà une licence",
...
GlobalNav.showLoggedInHTML = function(langKey, image, loginDisplayName){
      ...
      attr('style','background-image:url('+image+'), url('+defaultImage+')').attr('title', loginDisplayName);
      ...
      var dropdown = $("<ul></ul>").addClass('dropdown-menu')
